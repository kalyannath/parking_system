...
exports.initialize = async (req, res) => {
    ...
    try {
        ...
        const result = await TwoWheelerSlot.insertMany(slots);
...
exports.getAllSlots = async (req, res) => {
    try {
        const allSlots = await TwoWheelerSlot.find().select(ListSelectionFields);
...
exports.getAvailableSlots = async (req, res) => {
    try {
        const availableSlots = await TwoWheelerSlot.find({ isOccupied: false }).select(ListSelectionFields);
...
exports.getOccupiedSlots = async (req, res) => {
    try {
        const occupiedSlots = await TwoWheelerSlot.find({ isOccupied: true }).select(ListSelectionFields);
